...
export function TimeRestricted<
...
export function DayTimeRestricted<EvoClass extends MinimalEvo>(Base: EvoClass) {
  return TimeRestricted(6, 18, Base)
}

export function NightTimeRestricted<EvoClass extends MinimalEvo>(Base: EvoClass) {
