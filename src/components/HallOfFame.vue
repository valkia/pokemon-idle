...
<template class="modal fade" data-keyboard="false" data-backdrop="static" id="hallOfFameModal" tabindex="-1"
          role="dialog"
      ...
      <div class="modal-body">
        <p>
          ...
          You have grown up so much since you first left with <span
            data-bind="text: GameConstants.Starter[player.starter()]">{{Starter[player.starter]}}</span>!<br/>
          <br/>
