<template
  id="startSequenceModal" class="modal" tabindex="-1" role="dialog"
    ...
    <div class="modal-content">
      <div class="modal-header">
        <div style="width: 100%;">
          ...
          <h5 id="startSequenceModalLabel" class="modal-title">
            Professor Oak
          </h5>
        </div>
      </div>
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-warning mr-auto" href="#challengeModeModal" data-toggle="modal">
          Challenge Modes
        </button>
