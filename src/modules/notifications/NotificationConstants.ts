...
const NotificationConstants = {
  ...
  NotificationSound: {
    ...
    Farming: {
      ...
      berry_wither: new Sound('berry_wither', 'Berry about to wither/has withered'), 
      berry_mutated: new Sound('berry_mutated', 'Berry has mutated'),
      berry_replanted: new Sound('berry_replanted', 'Berry has been replanted'),
      berry_dropped: new Sound('berry_dropped', 'Berry has been dropped'),
      mulch_ran_out: new Sound('mulch_ran_out', 'Mulch has run out'),
